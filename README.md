<div align="center">
    <img src="https://github.com/capkpi/design/blob/master/logos/logo-2019/capkpi-gantt-logo.png" height="128">
    <h2>CapKPI Gantt</h2>
    <p align="center">
        <p>A simple, interactive, modern gantt chart library for the web</p>
        <a href="https://capkpi.github.io/gantt">
            <b>View the demo »</b>
        </a>
    </p>
</div>
...
### Install
```
npm install capkpi-gantt
```

### Usage
Include it in your HTML:
```
<script src="capkpi-gantt.min.js"></script>
<link rel="stylesheet" href="capkpi-gantt.css">
```
...
### Publishing
If you have publishing rights (CapKPI Team), follow these steps to publish a new version.
...
------------------
Project maintained by [capkpi](https://github.com/capkpi)
